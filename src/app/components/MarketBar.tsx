            ...
            <div className="flex items-center justify-between flex-row no-scrollbar overflow-auto pr-4">
                    ...
                    <div className="flex items-center flex-row space-x-8 pl-4">
                        <div className="flex flex-col h-full justify-center">
                            <p className={`font-medium tabular-nums text-greenText text-md`}>${ticker?.lastPrice}</p>
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className={` text-sm font-medium tabular-nums leading-5 text-sm ${Number(ticker?.priceChange) > 0 ? "text-greenText" : "text-redText"}`}>{Number(ticker?.priceChange) > 0 ? "+" : ""} {ticker?.priceChange} {Number(ticker?.priceChangePercent)?.toFixed(2)}%</p></div><div className="flex flex-col">
